...
import { RFIDPadHistoryCardConfig } from './types';
...
@customElement('rfidpad-history-card-editor')
export class RFIDPadHistoryCardEditor extends LitElement implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;
  @internalProperty() private _config?: RFIDPadHistoryCardConfig;
